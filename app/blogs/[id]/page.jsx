...
const Page = ( {params} ) => {
  ...
  const encodedSummary = encodeURIComponent(data ? data.description.slice(0, 200) : ''); // Adjust summary length as needed
  const source = encodeURIComponent('Your Website Name'); // Replace with your actual website name
