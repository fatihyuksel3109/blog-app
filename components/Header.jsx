  ...
  return (
    <header className='py-5 px-5 md:px-12 lg:px-28'>
        <div className='flex justify-between items-center'>
            ...
            <button className='flex items-center gap-1 hover:scale-105 transition-transform duration-300 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-solid border-black shadow-[-7px_7px_0px_#000000] active:bg-gray-200 '>Get started<Image src={assets.arrow_icon} width={12} alt='arrow icon' /></button>
        </div>
        <div className='text-center my-8'>
            ...
            <form className='flex justify-between max-w-lg scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]' action="">
