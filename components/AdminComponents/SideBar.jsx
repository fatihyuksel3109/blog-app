...
const SideBar = () => {
  return (
    <nav className='flex flex-col bg-slate-100'>
      <Link href={'/'} className="flex justify-center px-2 py-3 h-16 border border-black">
        <Image src={assets.logo_admin} alt='logo' width={82} />
      </Link>
      <div className='w-32 sm:w-60 lg:w-64 xl:w-80 2xl:w-96 h-lvh relative py-12 border border-black'>
        <div className='w-4/ sm:w-5/6 absolute right-0' >
         <Link href='/admin/add-blog/' className='flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000] hover:scale-105 transition-all duration-150'>
